...
#define meshtastic_Routing_init_default            \
    {                                              \
        0, {                                       \
            meshtastic_RouteDiscovery_init_default \
        }                                          \
    }
#define meshtastic_Data_init_default {_meshtastic_PortNum_MIN, {0, {0}}, 0, 0, 0, 0, 0, 0, false, 0}
#define meshtastic_KeyVerification_init_default \
    {                                           \
        0, {0, {0}}, {                          \
            0, {0}                              \
        }                                       \
...
#define meshtastic_FromRadio_init_default      \
    {                                          \
        0, 0, {                                \
            meshtastic_MeshPacket_init_default \
        }                                      \
    }
#define meshtastic_ClientNotification_init_default              \
    {                                                           \
        false, 0, 0, _meshtastic_LogRecord_Level_MIN, "", 0, {  \
            meshtastic_KeyVerificationNumberInform_init_default \
        }                                                       \
    }
...
#define meshtastic_Compressed_init_default \
    {                                      \
        _meshtastic_PortNum_MIN, {         \
            0, {0}                         \
        }                                  \
    }
#define meshtastic_NeighborInfo_init_default                                                                                                                                                                                                                                                                                                                   \
    {                                                                                                                                                                                                                                                                                                                                                          \
        0, 0, 0, 0, {                                                                                                                                                                                                                                                                                                                                          \
            meshtastic_Neighbor_init_default, meshtastic_Neighbor_init_default, meshtastic_Neighbor_init_default, meshtastic_Neighbor_init_default, meshtastic_Neighbor_init_default, meshtastic_Neighbor_init_default, meshtastic_Neighbor_init_default, meshtastic_Neighbor_init_default, meshtastic_Neighbor_init_default, meshtastic_Neighbor_init_default \
        }                                                                                                                                                                                                                                                                                                                                                      \
    }
...
#define meshtastic_ChunkedPayload_init_default \
    {                                          \
        0, 0, 0, {                             \
            0, {0}                             \
        }                                      \
    }
#define meshtastic_resend_chunks_init_default \
    {                                         \
        {                                     \
            {NULL}, NULL                      \
        }                                     \
...
#define meshtastic_Routing_init_zero            \
    {                                           \
        0, {                                    \
            meshtastic_RouteDiscovery_init_zero \
        }                                       \
    }
#define meshtastic_Data_init_zero {_meshtastic_PortNum_MIN, {0, {0}}, 0, 0, 0, 0, 0, 0, false, 0}
#define meshtastic_KeyVerification_init_zero \
    {                                        \
        0, {0, {0}}, {                       \
            0, {0}                           \
        }                                    \
...
#define meshtastic_FromRadio_init_zero      \
    {                                       \
        0, 0, {                             \
            meshtastic_MeshPacket_init_zero \
        }                                   \
    }
#define meshtastic_ClientNotification_init_zero                \
    {                                                          \
        false, 0, 0, _meshtastic_LogRecord_Level_MIN, "", 0, { \
            meshtastic_KeyVerificationNumberInform_init_zero   \
        }                                                      \
    }
...
#define meshtastic_Compressed_init_zero \
    {                                   \
        _meshtastic_PortNum_MIN, {      \
            0, {0}                      \
        }                               \
    }
#define meshtastic_NeighborInfo_init_zero                                                                                                                                                                                                                                                                                        \
    {                                                                                                                                                                                                                                                                                                                            \
        0, 0, 0, 0, {                                                                                                                                                                                                                                                                                                            \
            meshtastic_Neighbor_init_zero, meshtastic_Neighbor_init_zero, meshtastic_Neighbor_init_zero, meshtastic_Neighbor_init_zero, meshtastic_Neighbor_init_zero, meshtastic_Neighbor_init_zero, meshtastic_Neighbor_init_zero, meshtastic_Neighbor_init_zero, meshtastic_Neighbor_init_zero, meshtastic_Neighbor_init_zero \
        }                                                                                                                                                                                                                                                                                                                        \
    }
...
#define meshtastic_ChunkedPayload_init_zero \
    {                                       \
        0, 0, 0, {                          \
            0, {0}                          \
        }                                   \
    }
#define meshtastic_resend_chunks_init_zero \
    {                                      \
        {                                  \
            {NULL}, NULL                   \
        }                                  \
